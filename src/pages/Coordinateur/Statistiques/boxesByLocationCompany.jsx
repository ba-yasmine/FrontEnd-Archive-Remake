...
const VerticalBarChart = () => {
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_HOST_VAR}rest/company/getAllCompanies`,{ headers:{
          ...
          .then((response) =>{
            ...
            axios.get(`${process.env.REACT_APP_HOST_VAR}rest/analytics/findBoxesCountByStatutInCompany/${response.data[0].id}`,{ headers:{
                'Authorization': "Bearer" + userAuth.token
              }})
              .then((response) =>{
    ...
    const handleCompanyChange =(e)=>{
        ...
        axios.get(`${process.env.REACT_APP_HOST_VAR}rest/analytics/findBoxesCountByStatutInCompany/${id}`,{ headers:{
            'Authorization': "Bearer" + userAuth.token
          }})
          .then((response) =>{
            if(response.data){
    ...
    return (
        ...
        <div>
        <p style={{fontWeight:'600'}}>Boites groupées par emplacements</p>
