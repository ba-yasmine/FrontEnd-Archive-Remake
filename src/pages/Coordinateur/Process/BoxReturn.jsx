...
const handleCompanyState = (company) => {
  ...
  if (step === 0){
    return <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
      <BatchInitForm onStateChange={handleChildStateChange} onCompanyChange={handleCompanyState} on/>
    </div>
  }
...
<PanierBoxReturn provenanceId={selectedProventreetrance} datePicker={datePickDelivery} company={company}  />
