...
import {PanierReturn} from "./box-return"
import Card from 'react-bootstrap/Card';
import { faCartShopping } from '@fortawesome/free-solid-svg-icons'
import { ToastContainer, toast } from 'react-toastify';
import {TiDeleteOutline} from 'react-icons/ti'

function PanierBox({provenanceId}) {
...
//envoyer les boites selectionnées
    const sendRequ=() => {
          ...
          setLoading(true)
          axios.post(`${process.env.REACT_APP_HOST_VAR}rest/batches/createBatch/Box_Return/${userAuth.company}/${userAuth.ID}/${provenanceId}/${null}`,selectionRequest,{ headers:{
