...
const Header = ({title, arrow}) => {
  ...
  return (
    <div style={{ zIndex:'5',   display:'flex',justifyContent: 'space-between',alignItems:'center', color:'#0243cd', width:'90%', height:'8%', borderBottom:"2px solid #e5e7eb", paddingLeft:'20px', backgroundColor:'white', position:'fixed', paddingBottom:'8px', paddingRight:"10px"}}>
       <div>
